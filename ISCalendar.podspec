...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       An optional longer description of ISCalendar

                       * Markdown format.
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/ISCalendar"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Ivan Sinkarenko" => "ivan.sinkarenko@devbridge.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/ISCalendar.git", :tag => s.version.to_s }
